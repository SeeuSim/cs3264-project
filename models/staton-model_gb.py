...
# Train/Test Split and Model Training per Station using Gradient Boosting
station_predictions = {}
...
overall_classes = np.unique(np.concatenate([all_true, all_pred]))
print("\nOverall Classification Report:")
print(classification_report(
    all_true, 
    all_pred, 
    labels=overall_classes, 
    target_names=le.inverse_transform(overall_classes)
))
